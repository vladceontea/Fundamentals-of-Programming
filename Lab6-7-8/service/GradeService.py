...
from service.UndoService import FunctionCall, Operation, MultipleOperations
...
class GradeService:
    ...
    def delete_grades_student(self, student_id):
        ...
        self._undo_service.record(MultipleOperations(undo_delete_student, undo_delete_grades, redo_delete_student, redo_delete_grades))
    ...
    def delete_grades_discipline(self, discipline_id):
        ...
        self._undo_service.record(MultipleOperations(undo_delete_discipline, undo_delete_grades, redo_delete_discipline, redo_delete_grades))
